...
<body>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item active" href="boquet.php">Bouquets</a></li>
    ...
    <main class="container my-5">
        <h1 class="text-center mb-5">Our Beautiful Bouquets</h1>
        <div class="row">
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text flex-grow-1">A beautiful bouquet perfect for any occasion.</p>
                        <div class="d-flex justify-content-between align-items-center mt-3">
                            <span class="h5 mb-0">₹<?php echo number_format($product['price']); ?></span>
                            <div>
                                <form method="post" action="boquet.php" class="d-inline">
